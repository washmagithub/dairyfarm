...
public class cowaddinfodatatable extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cowaddinfodatatable);
        ...
        b4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new DatePickerDialog(cowaddinfodatatable.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                ...
                mDatabase.orderByChild("cid").equalTo(cowId).addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if (dataSnapshot.exists()) {
                            ...
                            Toast.makeText(cowaddinfodatatable.this, "Index already exists", Toast.LENGTH_SHORT).show();
                            progressDialog.dismiss();
                        } else {
                            // Cow ID is unique, proceed with saving the data
                            Model model = new Model(cowId, displayName, displayNumber, date, description);
                            mDatabase.child(mainCowId).child("info").child(cowId).setValue(model).addOnCompleteListener(task -> {
